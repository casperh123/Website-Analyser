...
{
    Task FindBrokenLinks(string url, Action<int> onLinkEnqueued, Action<int> onLinkChecked, Action<IndexedLink> onBrokenLinkFound);
}
...
public class BrokenLinkService : IBrokenLinkService
{
    ...
    public async Task FindBrokenLinks(string url, Action<int> onLinkEnqueued, Action<int> onLinkChecked, Action<IndexedLink> onBrokenLinkFound)
    {
        ModularCrawlResult<IndexedLink> crawlResult = GenerateCrawlResult(onLinkEnqueued, onLinkChecked, onBrokenLinkFound);
    ...
    private ModularCrawlResult<IndexedLink> GenerateCrawlResult(Action<int> onLinkEnqueued, Action<int> onLinkChecked, Action<IndexedLink> onBrokenLinkFound)
    {
